        ...
        <div className="container">
            <div className="md:flex items-center">
                ...
                <div className="mt-20 md:mt-0 md:h-[648px] md:flex-1 relative">
                    ...
                    <Image src={ cylinder} width={220} height={220} alt="Cylinder image" className="hidden md:block -top-8 -left-32 md:absolute"/>
                    <Image src={noodleImage} width={220} height={220} alt="Noodle image" className="hidden lg:block absolute top-[524px] left-[448px] rotate-[30deg]"/>
                </div>
            </div>
        </div>
    </section>
